  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div ref={trialCardRef} className="bg-white rounded-3xl shadow-xl p-8 md:p-12 mb-16 border-4 border-[#0ea5e9] opacity-0 translate-y-8 transition-all duration-700">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-3xl font-black text-gray-900">
              無料体験を<br className="md:hidden" />
              <span className="text-[#0ea5e9]">ご希望の方へ</span>
            </h2>
          </div>
          
          <p className="text-gray-700 leading-relaxed mb-6 text-base">
            「どんな雰囲気か知りたい」「続けられるか不安…」<br />
            そんな方こそ、まずは体験参加がおすすめです!<br />
          ...
          <ul className="space-y-4 mb-8">
            <li className="flex items-start gap-3">
              ...
              <span className="text-gray-700 text-base">
                無料体験は<strong className="text-[#0ea5e9]">随時受付中</strong>です
              </span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-6 h-6 bg-[#0ea5e9] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-sm font-bold text-gray-500 tracking-wider">HOW TO JOIN</span>
        ...
        <div className="space-y-8 mb-16">
          <div ref={step1Ref} className="flex gap-6 opacity-0 translate-y-8 transition-all duration-700">
            ...
            <div className="flex-1 bg-white rounded-2xl shadow-lg p-6 md:p-8">
              <h3 className="text-2xl font-black text-gray-900 mb-4">入会申込書の記入</h3>
              <p className="text-gray-700 leading-relaxed mb-6 text-base">
                「入会申込書はこちら」をクリックし、申込書を印刷の上、必要事項をご記入ください。
              </p>
              <a
                href="https://ysc-2009.github.io/ysc.github.io/images/入会申込書.xls"
                download
          ...
          <div ref={step2Ref} className="flex gap-6 opacity-0 translate-y-8 transition-all duration-700">
            <div className="flex flex-col items-center flex-shrink-0">
              <div className="w-16 h-16 bg-gradient-to-br from-[#0ea5e9] to-[#38bdf8] rounded-2xl flex items-center justify-center text-white text-2xl font-black shadow-lg">
                2
              </div>
            ...
            <div className="flex-1 bg-white rounded-2xl shadow-lg p-6 md:p-8">
              <h3 className="text-2xl font-black text-gray-900 mb-4">入会申込書の提出</h3>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-700">
                      <strong className="text-amber-700">ゆうちょ銀行の口座について:</strong><br />
          ...
          <div ref={step3Ref} className="flex gap-6 opacity-0 translate-y-8 transition-all duration-700">
            <div className="flex flex-col items-center flex-shrink-0">
              <div className="w-16 h-16 bg-gradient-to-br from-[#0ea5e9] to-[#38bdf8] rounded-2xl flex items-center justify-center text-white text-2xl font-black shadow-lg">
                3
              </div>
            ...
            <div className="flex-1 bg-white rounded-2xl shadow-lg p-6 md:p-8">
              <h3 className="text-2xl font-black text-gray-900 mb-4">ゆうちょ銀行 自動振込申込書の提出</h3>
              <p className="text-gray-700 leading-relaxed mb-4 text-base">
              ...
              <div className="bg-sky-50 border-l-4 border-[#0ea5e9] p-4 rounded-lg">
                <p className="text-sm text-gray-700">
                  提出時は<strong className="text-[#0ea5e9]">通帳と印鑑</strong>をご持参いただくことをおすすめします。<br />
                  ※提出から承認まで<strong className="text-[#0ea5e9]">2〜3週間</strong>ほどかかります。
                </p>
              </div>
            </div>
          </div>

          <div ref={step4Ref} className="flex gap-6 opacity-0 translate-y-8 transition-all duration-700">
            <div className="flex flex-col items-center flex-shrink-0">
              <div className="w-16 h-16 bg-gradient-to-br from-[#0ea5e9] to-[#38bdf8] rounded-2xl flex items-center justify-center text-white text-2xl font-black shadow-lg">
                4
              </div>
            ...
            <div className="flex-1 bg-white rounded-2xl shadow-lg p-6 md:p-8">
              <div className="flex items-center gap-3 mb-4">
                <span className="material-symbols-outlined text-[#0ea5e9] text-3xl">check_circle</span>
                <h3 className="text-2xl font-black text-gray-900">入会受付確認書の受領</h3>
              </div>
        ...
        <div ref={paymentRef} className="bg-gradient-to-br from-sky-50 to-blue-50 rounded-2xl p-8 md:p-10 mb-12 border border-sky-200 opacity-0 translate-y-8 transition-all duration-700">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 h-14 bg-white rounded-xl flex items-center justify-center shadow-md">
              <span className="material-symbols-outlined text-[#0ea5e9] text-3xl">payments</span>
            </div>
            <h3 className="text-2xl font-black text-gray-900">お支払いについて</h3>
          </div>
          <p className="text-gray-700 leading-relaxed text-base">
            年会費・保険料・教室参加費は、<strong className="text-[#0ea5e9]">ゆうちょ銀行の自動振込</strong>にてお支払いいただきます。<br />
            詳細は入会申込書受理時にご説明いたします。<br />
            会費の詳細については<a href="/members" className="text-[#0ea5e9] font-bold hover:underline cursor-pointer">会員様向けページの「費用について」</a>もご参照ください。
          </p>
        </div>

        <div ref={ctaRef} className="bg-gradient-to-br from-[#0ea5e9] to-[#38bdf8] rounded-3xl p-8 md:p-12 text-white text-center shadow-2xl opacity-0 translate-y-8 transition-all duration-700">
