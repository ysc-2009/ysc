...
const SHEET_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSample_Report/pub?gid=0&single=true&output=csv';
...
const fallbackReports: ReportItem[] = [
  ...
  },
  {
    ...
    date: '2026/02/15',
    title: 'サッカー教室',
    excerpt: '毎週土曜日のサッカー教室の様子です。基礎練習からミニゲームまで、楽しく活動しています。',
  ...
  },
  {
    ...
    date: '2026/02/10',
    title: 'スポーツ鬼ごっこ大会',
    excerpt: '地域のスポーツ鬼ごっこ大会に参加しました。チームワークを発揮して頑張りました！',
    image: 'https://ysc-2009.github.io/ysc.github.io/img/award1.jpg'
  },
  {
    id: 4,
    ...
    date: '2026/01/28',
    title: 'ジャズダンス発表会',
    excerpt: '東部コミュニティセンターでジャズダンスの発表会を開催しました。練習の成果を披露できました。',
    image: 'https://ysc-2009.github.io/ysc.github.io/img/award2.jpg'
  },
  {
    id: 5,
    ...
    date: '2026/01/20',
    title: 'ショートテニス練習',
    excerpt: 'ショートテニス教室の練習風景です。初心者から経験者まで楽しく活動しています。',
    image: 'https://ysc-2009.github.io/ysc.github.io/img/award1.jpg'
  },
  {
    id: 6,
  ...
  },
  {
    ...
    date: '2025/12/25',
    title: 'クリスマスイベント',
    excerpt: '年末のクリスマスイベントを開催しました。子どもたちと楽しい時間を過ごしました。',
    image: 'https://ysc-2009.github.io/ysc.github.io/img/award1.jpg'
  },
  {
    id: 8,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Filter Buttons */}
        <div ref={filterRef} className="flex flex-wrap gap-3 justify-center mb-12 opacity-0 translate-y-8 transition-all duration-700">
          {filters.map((filter) => (
            <button
              key={filter.id}
            ...
            >
              <span className="material-symbols-rounded text-lg">{filter.icon}</span>
              {filter.label}
            </button>
          ))}
        </div>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm text-gray-500 font-medium">{report.date}</span>
        ...
        {filteredReports.length === 0 && (
          <div className="text-center py-20">
            <div className="w-20 h-20 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <span className="material-symbols-rounded text-[#0ea5e9] text-4xl">search_off</span>
            </div>
            <p className="text-gray-500 text-lg">該当する活動報告がありません</p>
          </div>
        )}
      </div>
