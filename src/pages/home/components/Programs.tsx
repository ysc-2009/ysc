...
export default function Programs() {
  ...
  return (
    <section id="programs" className="py-24 bg-gradient-to-b from-sky-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={headerRef} className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-16 gap-6 opacity-0 translate-y-8 transition-all duration-700">
          <div>
          ...
          <a href="/info" className="flex items-center gap-2 text-[#0ea5e9] font-bold hover:gap-3 transition-all cursor-pointer whitespace-nowrap">
            すべての教室を見る
          ...
          {programs.map((program, index) => (
            ...
            >
              <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mb-6 shadow-md">
                <span className="material-symbols-outlined text-[#0ea5e9] text-3xl">{program.icon}</span>
              </div>
              <h3 className="text-xl font-black text-gray-900 mb-4">{program.name}</h3>
