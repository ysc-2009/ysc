        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-8">
              安原スポーツクラブは、<strong className="text-gray-900">2009年にTOTOの援助を受け、設立</strong>いたしました。
            ...
            <div className="grid sm:grid-cols-3 gap-6 mb-8">
              <div className="text-center p-6 bg-sky-50 rounded-xl">
                ...
                <p className="text-sm font-bold text-gray-900">青少年の<br />健全育成</p>
              </div>
              <div className="text-center p-6 bg-sky-50 rounded-xl">
                <div className="w-12 h-12 bg-[#0ea5e9] rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="material-symbols-outlined text-white text-2xl">favorite</span>
                </div>
                <p className="text-sm font-bold text-gray-900">健康・体力<br />づくり</p>
              </div>
              <div className="text-center p-6 bg-sky-50 rounded-xl">
                <div className="w-12 h-12 bg-[#0ea5e9] rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="material-symbols-outlined text-white text-2xl">location_city</span>
                </div>
                <p className="text-sm font-bold text-gray-900">地域<br />コミュニティ</p>
              </div>
            </div>
            <a href="/about" className="inline-flex items-center gap-2 px-8 py-4 bg-[#0ea5e9] text-white font-bold rounded-full hover:bg-[#0284c7] transition-all duration-300 shadow-lg hover:shadow-xl cursor-pointer whitespace-nowrap">
              詳しく見る
